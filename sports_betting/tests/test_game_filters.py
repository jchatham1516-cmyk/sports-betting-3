...
def test_filter_games_window_keeps_only_games_between_now_and_next_48_hours(monkeypatch):
    ...
    raw_games = [
        ...
        {"id": "in_end", "commence_time": "2025-01-17T18:00:00Z"},
        {"id": "out_before", "commence_time": "2025-01-15T17:59:00Z"},
        {"id": "out_after", "commence_time": "2025-01-17T18:01:00Z"},
    ]
...
def test_filter_games_for_today_aliases_filter_games_window(monkeypatch):
    ...
    raw_games = [
        ...
        {"id": "out_window", "commence_time": "2025-01-17T19:00:00Z"},
    ]

    assert game_filters.filter_games_for_today(raw_games) == game_filters.filter_games_window(raw_games)


def test_current_sports_day_window_returns_now_to_now_plus_48h(monkeypatch):
    monkeypatch.setattr(game_filters, "datetime", _FixedUTC)
    ...
    assert end == expected_start + timedelta(hours=48)
